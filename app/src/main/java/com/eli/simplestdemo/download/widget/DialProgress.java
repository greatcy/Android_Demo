package com.eli.simplestdemo.download.widget;
...
import com.eli.simplestdemo.download.MiscUtil;

/**
 * Created by chenjunheng on 2018/4/11.
 * dial progress
 * TODO 可能是由于浮点数的原因，在某些设备上会抖动
 */
...
public class DialProgress extends View {
     ...
     * @param unit
     */
    public void setValue(float value, CharSequence unit) {
        if (value > mMaxValue) {
            value = mMaxValue;
        }
        this.mUnit = unit;
