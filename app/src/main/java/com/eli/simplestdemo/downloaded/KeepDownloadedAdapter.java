...
// */
//class KeepDownloadedAdapter extends RecyclerView.Adapter<KeepDownloadedAdapter.ViewHolder> implements ActionModeCallback.ActionModeReCallBack {
//    private static final String TAG = KeepDownloadedAdapter.class.getSimpleName();
//
...
//    public KeepDownloadedAdapter(String[] myDataset) {
//        mDataSet = myDataset;
//    }
//
//    // Create new views (invoked by the layout manager)
//    @Override
//    public KeepDownloadedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
//                                                               int viewType) {
//        // create a new view
...
//                ActionModeCallback tamc = new ActionModeCallback(KeepDownloadedAdapter.this);
...
//                // 用于PopupWindow的View
//                View contentView = LayoutInflater.from(holder.optionMenu.getContext()).inflate(R.layout.downloading_item_menu, null, false);
//                // 创建PopupWindow对象，其中：
